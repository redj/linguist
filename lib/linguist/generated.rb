module Linguist
  class Generated
    ...
    # Internal: Is the blob a lexical scanner generated by Flex?
    #
    # Returns true or false.
    def flex_lexical_scanner?
      #return false unless ['.h', 'c', '.cc', '.cpp'].include?(extname)
      for i in 0..15
        break if i+1 > lines.count
        if lines[i].include?("A lexical scanner generated by flex")
          return true
        end
      end
      return false
    ...
    # Internal: Is the blob a parser generated by Bison?
    #
    # Returns true or false.
    def bison_parser?
      #return false unless ['.h', '.c', '.cc', '.cpp', '.java'].include?(extname)
      for i in 0..15
        break if i+1 > lines.count
        if lines[i].include?("A Bison parser, made by GNU Bison")
          return true
        end
      end
      return false
    ...
    # Internal: Is the blob a C source file generated by an eC compiler?
    #
    # Returns true or false.
    def ec_generated_code?
      return false unless extname == '.c'
      return false unless lines.count > 1

      return lines[0].include?("Code generated from eC source file")
    end
  end
end
